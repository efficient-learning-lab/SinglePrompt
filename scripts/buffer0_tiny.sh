MODE="Default"
DATASET="tinyimagenet" # cifar10, cifar100, tinyimagenet, imagenet, imagenet-r, nch, cub200
N_TASKS=5
N=50
M=10
...
do
    ...
    python -W ignore main.py --mode $MODE \
        ...
        --pos_prompt $POS_PROMPT --prompt_length $PROMPT_LENGTH --logit_type $LOGIT_TYPE
