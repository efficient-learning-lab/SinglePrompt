...
class BufferTrainer(_Trainer):
    def __init__(self, *args, **kwargs):
        super(BufferTrainer, self).__init__(*args, **kwargs)
    ...
    def online_step(self, images, labels, idx):
        ...
        if len(self.memory) > 0 and self.memory_batchsize > 0:
            ...
            self.memory_sampler = MemoryBatchSampler(self.memory, memory_bs, self.temp_batchsize * self.online_iter)
